...
public class AbstractListElementTest {
    ...
    public void items_returnsItemsList() {
        ...
        assertThat(items.get(0).webElement().webElement()).isSameAs(itemOne);
        assertThat(items.get(1)).isInstanceOf(ListItemElement.class);
        assertThat(items.get(1).webElement().webElement()).isSameAs(itemTwo);
    }
    ...
    public void find_returnsFirstItem() {
        ...
        assertThat(listItemElement.webElement().webElement()).isSameAs(itemOne);
    }
    ...
    public void findAll_returnsFirstAndSecondItem() {
        ...
        assertThat(listItems.get(0).webElement().webElement()).isSameAs(itemOne);
        assertThat(listItems.get(1).webElement().webElement()).isSameAs(itemTwo);
    }
